...
public:
	void init() {
		...
		// stand.
		pitch_stand.setup(XOR("pitch"), XOR("pitch_stnd"), { XOR("off"), XOR("down"), XOR("up"), XOR("random"), XOR("ideal"), XOR("zero") });
		...
		yaw_walk.setup(XOR("yaw"), XOR("yaw_walk"), { XOR("off"), XOR("direction"), XOR("jitter"), XOR("rotate"), XOR("random"), XOR("sakura") });
		...
		// air.
		pitch_air.setup(XOR("pitch"), XOR("pitch_air"), { XOR("off"), XOR("down"), XOR("up"), XOR("random"), XOR("ideal"), XOR("zero") });
		pitch_air.AddShowCallback(callbacks::IsAntiAimModeAir);
		RegisterElement(&pitch_air);

		yaw_air.setup(XOR("yaw"), XOR("yaw_air"), { XOR("off"), XOR("direction"), XOR("jitter"), XOR("rotate"), XOR("random"), XOR("sakura") });
		...
		fakelag_conditions.setup("", XOR("lag_active"), { XOR("stand"), XOR("move"), XOR("air"), XOR("crouch"), XOR("lby update") }, false);
		...
		fakelag_limit.setup(XOR("limit"), XOR("lag_limit"), 2, 16, true, 0, 2, 1.f);
		...
		fakelag_breaklc.setup(XOR("break lagcomp"), XOR("fakelag_breaklc"));
		...
		landlen.setup(XOR("animation duration"), XOR("landlen"), 0, 2500.f, false, 0.f, 1000.f, 100.f);
...
public:
	void init( ) {
		...
		walls_amount.setup("asus walls", XOR("walls_amount"), 0.f, 100, true, 0, 100, 1.f, XOR(L"%"));
		walls_amount.SetCallback(Visuals::ModulateWorld);
		RegisterElement(&walls_amount, 1);

		transparent_props_amount.setup("asus props", XOR("transparent_props_amount"), 0.f, 100.f, true, 0, 75.f, 1.f, XOR(L"%"));
		...
		ambient_alpha.setup("", XOR("ambient_alpha"), 2.f, 255.f, false, 0, 255.f, 1.f, XOR(L"%"));
...
public:
	void init( ) {
		...
		fake_latency_amt.setup("", XOR("fake_latency_amt"), 50.f, 1000.f, false, 0, 200.f, 10.f, XOR(L"ms"));
		...
		secondary_fake_latency_amt.setup("", XOR("secondary_fake_latency_amt"), 50.f, 500.f, false, 0, 200.f, 10.f, XOR(L"ms"));
